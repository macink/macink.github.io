...
- Building ML architectures that incorporate detector resolution that varies in phase space so the model learns the true momentum transfer ($|t|$) distribution rather than memorizing smeared patterns
- Using Fourier features data preprocessing to improve learning across wide dynamic ranges
